...
func main() {
	...
	userApp := user.NewApplication(database.UserData(database.Client, "Users"), database.StoreData(database.Client, "Store"), database.ProductData(database.Client, "Products"))
